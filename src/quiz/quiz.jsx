...
const Quiz = () => {
	...
	return (
		<div className={styles.divQuiz}>
			<div className={styles.quizContainer + " " + styles.containerQuiz}>
				{quizCompleted ? (
					<div>
					...
					<div>
						<h1 className={styles.titreQuiz}>QUIZ</h1>
						...
						<div className={styles.buttonContainer}>
							<button className={styles.btn + " " + styles.prev_btn} id="prev-btn" onClick={() => changeQuestion(-1)}>
								Question précédente
							</button>
							<button className={styles.btn + " " + styles.next_btn} id="next-btn" onClick={nextQuestion}>
